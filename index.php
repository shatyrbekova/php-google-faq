...
<body>
    <div class="container">
        ...
        [
            ...
            <p> Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel  <a hrep> Centro Google per la sicurezza online </a> .</p>
        ...
        [
            ...
            <ol> La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
        ...
        <!-- Popolare con ciclo foreach -->
        <?php
         foreach($sentences as $sentence) {?>

             <div class="questions">
                 <h2><?php print $sentence['question']?></h2>
             </div>
             <div class="answers">
             <p><?php print $sentence['answer']?></p>
             </div>
        <?php }
     ?>
    </div>
